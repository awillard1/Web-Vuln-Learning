...
<script>
var x = 'helloworld<?php echo str_replace('prompt','',str_replace('confirm','',str_replace('+','',str_replace('document','',str_replace('alert','',str_replace(';','',str_replace('/','',str_ireplace('script','',$_GET["xss"]))))))));?>';
</script>
